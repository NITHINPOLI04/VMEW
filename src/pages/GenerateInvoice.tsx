  ...
  const handleItemChange = (index: number, field: keyof InvoiceItem, value: string | number) => {
    ...
    if (field === 'quantity' || field === 'rate') {
      ...
      updatedItems[index] = {
        ...
        [field]: Number(value),
        taxableAmount,
        sgstAmount: (taxableAmount * updatedItems[index].sgstPercentage) / 100,
        cgstAmount: (taxableAmount * updatedItems[index].cgstPercentage) / 100,
        igstAmount: (taxableAmount * updatedItems[index].igstPercentage) / 100
      };
      ...
      updatedItems[index] = {
        ...updatedItems[index],
        [field]: percentage,
        [taxField]: (updatedItems[index].taxableAmount * percentage) / 100
      };
    } else {
      updatedItems[index] = {
        ...updatedItems[index],
